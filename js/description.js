		...
		<div class="des-m" style="width: 1190px;
			...
			<div class="shang" style="width: 1190px;
				...
				<div class="mirror" style="width: 422px;
							height: 555px;
							float: left;">
					<div class="backmirr" style="background: url(http://images.bxmedia.net/upload/1/2016/4/10/92/27f1b-a0e0-48b1-b951-4e41e913afe.jpg) no-repeat;
							width: 420px;
							height: 420px;
				...
				<div class="descript" style="width: 537px;
					...
					<div class="infotitle" style="width: 540px;
								...
								margin-bottom: 10px;">
						君主论<br/>
						<p style="margin-top: 2px;font-size: 12px;"><span style="color: #2362AF;">尼科洛·马基雅维里</span>&nbsp;(作者)&nbsp;<span style="color: #2362AF;">潘汉典</span>&nbsp;(译者)&nbsp;</p>
					</div>
					<ul>
						<li class="shoujia"><label style="width: 60px;
												...
												line-height: 35px;
												margin-top: 10px;
												margin-right: 8px;">销&nbsp;&nbsp;售&nbsp;&nbsp;价</label><span style="font-size: 34px;color: #ED1F23;"><span style="font-size: 18px;">￥</span>12.75</span><i style="font-size: 13px;
						color: #ED1F23;
						font-style: normal;
						margin-left: 10px;">[8.5折][库存13件]</i>&nbsp;
					...
					width: 537px;"><label style="width: 60px;
												...
												line-height: 35px;
												margin-top: 10px;
												margin-right: 8px;">市&nbsp;&nbsp;场&nbsp;&nbsp;价</label><span style="text-decoration: line-through;color: #999999;">￥15.0</span></li>
					...
					width: 537px;color: #5c5c5c;"><label style="width: 60px;
						...
						margin: 5px 5px 0 0;
						vertical-align: middle;"></span>(共有0条评论)</li>
					...
					width: 537px;color: #666666;"><label style="width: 60px;
												...
												line-height: 35px;
												margin-top: 10px;
												margin-right: 8px;">服&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;务</label>&nbsp;&nbsp;由&nbsp;&nbsp;<a href="" style="color: #2362AF;">中关村图书大厦</a>&nbsp;&nbsp;负责发货，并提供售后服务。</li>
						<li class="xinxi" style="color: #666666;"><label style="width: 60px;
						    ...
						    <p style="text-indent: 58px;line-height: 20px;">出版社：商务印书馆</p>
							<p style="text-indent: 58px;line-height: 20px;">出版日期：1985-07-01</p>
				...
				<div class="shopmessige" style="width: 210px;
					...
					<div class="shop-info" style="width: 208px;
						...
						<div class="b-rows" style="width: 192px;
							...
							line-height: 22px;">中关村图书大厦</a></div>
				...
				<div class="xia-left" style="width: 980px;
					...
					<div class="xllist-n" style="width: 936px;
						...
						<div class="xllist1-txt" style="padding: 10px 14px;   
										color: #333333;
										line-height: 26px;
										overflow: hidden;">《君主论》是一本毁誉参半、不可不读的奇书，一直被奉为欧洲历代君主的案头之书，政治家的高指南，统治阶级巩固其统治的治国原则，和人类有史以来对政治斗争技巧最独到最精辟的解剖。自1532年开始印行，迄今470多年，从西方到东方，本书在政界、宗教界、学术等领域引起巨大的反响，被西方评论界列为和《圣经》、《资本论》等相提并论的影响人类历史的十部著作之一。 </div>
					</div>
					<div class="xl-list2">
						<div class="xllist-n" style="width: 936px;
									padding-left: 8px;
